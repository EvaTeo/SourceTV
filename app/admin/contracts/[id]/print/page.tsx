...
<main className="min-h-screen bg-zinc-950 px-4 pb-8 pt-28 text-black print:bg-white print:p-0">
      ...
      <article className="mx-auto max-w-4xl bg-white px-10 py-12 shadow-2xl print:max-w-none print:shadow-none">
        ...
        <section className="mt-8 grid gap-4 border-b border-black/20 pb-8 text-sm md:grid-cols-2">
          ...
          <Info label="Partner Email" value={contract.partnerEmail || "Not set"} />
          <Info label="Rights Owner" value={contract.rightsOwner || "Not set"} />
          <Info label="Rights Contact" value={contract.rightsContact || "Not set"} />
          ...
          <Info label="Revenue Share" value={`${contract.revenueShare ?? 50}%`} />
          <Info label="License Start" value={formatDate(contract.licenseStartDate)} />
          <Info label="License End" value={formatDate(contract.licenseEndDate)} />
        ...
        <section className="mt-10 border-t border-black/20 pt-8">
...
<div className="mt-3 rounded-md border border-black/20 bg-white p-4">
    ...
    />
                ...
                <p className="mt-3 text-sm text-black/50">No signature saved.</p>
              )}
            </div>
          </div>
        </section>
