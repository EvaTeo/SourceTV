...
import {
  fetchHeroProjects,
  saveHeroProjectOrder,
  updateHeroProject,
  type HeroContentProject,
} from "../lib/editorialHeroApi";
...
export default function HeroManager() {
  ...
  async function saveHeroSettings(
    ...
    if (
      ...
      window.alert(
        "Hero priority must be 1 or higher."
      );
    ...
    if (
      ...
      window.alert(
        "The hero end date must be after its start date."
      );
  ...
  async function reorderHeroes(
    reordered: HeroProject[]
  ) {
