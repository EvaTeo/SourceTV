  ...
  (item.backdropUrl ||
    item.thumbnailUrl) && (
                    ...
                    >
                      {active && (
                        <span
                          ...
                          className="hero-progress absolute inset-y-0 left-0 rounded-full bg-sky-300 shadow-[0_0_14px_rgba(56,189,248,0.8)]"
                        />
                      )}
                    </button>
                  );
      ...
      <style jsx>{`
        .hero-progress {
          width: 0%;
          animation: heroProgress
            ${HERO_DURATION}ms linear forwards;
        }
