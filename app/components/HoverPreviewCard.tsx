...
export default function HoverPreviewCard({
  ...
  const [playerClosing, setPlayerClosing] =
    useState(false);
  ...
  const [popupOrigin, setPopupOrigin] =
  ...
  return (
    <>
      ...
      >
        ...
        >
          <div className="relative aspect-[2/3] overflow-hidden rounded-[0.85rem] bg-zinc-950 shadow-[0_10px_26px_rgba(0,0,0,0.28)] transition duration-300 group-hover:scale-[1.055] group-hover:shadow-[0_18px_42px_rgba(0,0,0,0.55)]">
            {item.thumbnailUrl && (
              <img
