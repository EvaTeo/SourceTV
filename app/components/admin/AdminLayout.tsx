...
<div className="min-h-screen pl-72">
          ...
          <div className="flex h-16 items-center justify-end px-8">
            <div className="flex items-center gap-3">
              ...
              <button className="flex h-10 w-10 items-center justify-center rounded-xl border border-white/10 bg-white/[0.035] transition hover:border-sky-300/35 hover:bg-sky-300/10">
                <svg
